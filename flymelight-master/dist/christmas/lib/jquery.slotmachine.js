...
(function($) {
	...
	$(document).ready(function(){
		...
		if( $("filter#slotMachineBlurSVG").length<=0 ){
			$("body .svg").append('<svg version="1.1" xmlns="http://www.w3.org/2000/svg">'+
	...
	*/
	$.fn.slotMachine = function(settings){
		...
		var	$slot = $(this), //jQuery selector
			...
			$titles = $slot.find(".slot"), //Slot Machine elements
		...
		*/
		...
		/*
		//this block of source code modified on 20141214 by sk
		$titles.wrapAll("<div class='slotMachineContainer' />");
		$container = $slot.find(".slotMachineContainer");
		*/
		...
		*/
		...
		/* new added on 20141214 by sk - BEGIN*/
		$slot.appslot = function(){
		    _stop(true, _appslot);
		};
		function  _appslot(){
